...
<head>
  ...
  <title>Manager Portal: My Employees</title>
  <!-- plugins:css -->
...
<body>
        ...
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Hello, <span class="text-black fw-bold">
              ...
              ?></span></h1>
            <h3 class="welcome-sub-text">Here are your employees</h3>
          </li>
        </ul>
                  ...
                  <div class="row">
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div style="position: static !important;" class="dropdown-menu show" aria-labelledby="dropdownMenuButton1">
                          <table id="employees">

                            <tr>
                                <th colspan="3">MY EMPLOYEES</th>
                            </tr>
  ...
  <script src="managers_employees.js"></script>
