...
<head>
  ...
  <title>Employee Portal: Personal Details</title>
  <!-- plugins:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text" id="greeting">Hello, <span class="text-black fw-bold" id="name">
            <?php
                session_start();
                echo $_SESSION['username'];
            ?></span></h1>
            </span></h1>
            <h3 class="welcome-sub-text">Here are your Personal Details</h3>
          </li>
        </ul>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton1">
                          <h6 class="dropdown-header">Employee ID</h6>
                          <!-- <a class="dropdown-item" href="#"></a> -->
                          <a class="dropdown-item" href="#" id="employee_id"></a>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton2">
                          ...
                          <!-- <a class="dropdown-item" href="#" ></a> -->
                          <a class="dropdown-item" href="#" id="qualifications"></a>
                          <a class="dropdown-item" href="#" id="skills"></a>
                          <!-- <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div>
                      </div>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton3">
                          <h6 class="dropdown-header">Numbers</h6>
                          <!-- <a class="dropdown-item" href="#">Action</a> -->
                          <a class="dropdown-item" href="#" id="phone_number"></a>
                          <a class="dropdown-item" href="#" id="home_number"></a>
                          <!-- <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div>
                      </div>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton4">
                          ...
                          <!--- <a class="dropdown-item" href="#">Action</a> -->
                          <a class="dropdown-item" href="#" id="email_id"></a>
                          <a class="dropdown-item" href="#" id="fax"></a>
                          <!--- <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div> 
                      </div>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton8">
                          <h6 class="dropdown-header">Work Details</h6>
                          <a class="dropdown-item" href="#" id="designation"></a>
                          <a class="dropdown-item" href="#" id="department"></a>
                          <a class="dropdown-item" href="#" id="manager"></a>
                          <a class="dropdown-item" href="#" id="start_date"></a>
                          <a class="dropdown-item" href="#" id="experience_in_company"></a>
                          <!-- <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div> 
                      </div>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton6">
                          <h6 class="dropdown-header">Address</h6>
                          <a class="dropdown-item" href="#" id="building_name"></a>
                          <a class="dropdown-item" href="#" id="city"></a>
                          <a class="dropdown-item" href="#"id="country"></a>
                          <a class="dropdown-item" href="#"id="zipcode"></a>
                          <!-- <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div>
                      </div>
                    ...
                    <div class="col-md-3 dropdown-menu-static-demo">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton7">
                          ...
                          <!-- <a class="dropdown-item" href="#">Action</a> -->
                          <a class="dropdown-item" href="#" id="date_of_birth"></a>
                          <a class="dropdown-item" href="#" id="gender"></a>
                          <!-- <a class="dropdown-item" href="#">Something else here</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#">Separated link</a> -->
                        </div>
